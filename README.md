...
Sou estudante de Análise e Desenvolvimento de Sistemas na UAM (São Paulo) e trabalho atualmente com suporte técnico, onde uso Delphi e MySQL no dia a dia.

Estou em transição para o desenvolvimento de software, com foco em Java e construção de projetos práticos que resolvem problemas reais. Acredito que a melhor forma de aprender é fazendo — por isso cada repositório aqui é parte da minha evolução.
...
> _"Todo especialista já foi um dia iniciante. O que importa é não parar de aprender."_
